...
#define OutputDebugStringA(a) { __android_log_print(ANDROID_LOG_INFO, "MMFRuntimeNative", "OutputDebugStringA: function %s, line %i: info %s.", __PRETTY_FUNCTION__, __LINE__, a); }
#include <wchar.h>
#include <string.h>
#include <signal.h>
#ifndef _UNICODE
